...
%% Select different channels with cfg.channel, also find the typical sensor noise, also add correlatted noise (maybe this is added by adding dipoles inside the head (background brain activity) and outside the head (correlated noise from environmental sources like a car or elevator*))
